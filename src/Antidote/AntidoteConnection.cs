#region copyright
// -----------------------------------------------------------------------
//  <copyright file="AntidoteConnection.cs" creator="Bartosz Sypytkowski">
...
namespace Antidote
{
    public sealed class AntidoteConnection : ICrdtFactory, IDisposable
    {

        public AntidoteConnection() : this(AntidoteConnectionSettings.Default)
        {
        }

        public AntidoteConnection(AntidoteConnectionSettings settings)
        {
        }

        public async Task OpenAsync(string host, ushort port)
        {
            throw new NotImplementedException();
        }

        public async Task OpenAsync(IEnumerable<EndPoint> endpoints)
        {
            throw new NotImplementedException();
        }

        public async Task UpdateAsync<T>(AntidoteObject<T> crdt)
        {
            throw new NotImplementedException();
        }
