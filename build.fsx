...
let product = "Antidote"
let authors = [ "Bartosz Sypytkowski" ]
let copyright = "Copyright © 2017 SyncFree"
let company = "Bartosz Sypytkowski"
let description = ".NET client for AntidoteDB"
let tags = ["antidote"; "antidotedb"; "crdt"; "eventual consistency"]
...
Target "Protobuf" <| fun _ ->
    ...
    let protoFiles = [
        ("antidote.proto", "/src/Antidote/Proto/") ]
